...
| 4 — Quantity verification | IN PROGRESS | Groundplan extraction fleet running (5 sets) → `04_Quantity_Reconciliation/groundplan_*.md`; synthesis to QUANTITY_RECONCILIATION.xlsx next |
