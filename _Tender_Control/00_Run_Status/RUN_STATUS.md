...
| 1 — Read everything | IN PROGRESS | Addendum notices ×7 read in full (orchestrator). Fan-out reading of VOL 21/38/17/06/11/15, geotech, Design Report, Schedule 3, Denis notes underway → notes in `01_Document_Register/notes/` |
| 2 — Scope matrix | pending | |
| 3 — Cost model audit | pending | |
