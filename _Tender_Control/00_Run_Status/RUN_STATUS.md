...
| 7 — Programme/labour/plant | IN PROGRESS | Activity-based build-up agent running → `05_Programme_Labour_Plant/PROGRAMME_LABOUR_PLANT.xlsx` + LABOUR_REVIEW_PACK.md (hours/days basis; $ attached in Phase 6 at ×1.08 rates) |
