# Groundplan Take-off Extraction — Public Amenities (PAM) Hydraulic, Rev T1
...
## 1. File-to-sheet map and revision check

| File | Underlying sheet (from rendered titleblock) | Sheet title | Rev | Mark-up present? |
|---|---|---|---|---|
...
**Revision check: every underlying sheet is Rev T1 "ISSUE FOR TENDER" dated 17.06.2026 — nothing other than T1 found.** (Cover-sheet drawing schedule also lists all 8 sheets at T1.)

---

## 2. Legend transcription — Plan D (`D H-PAM-~1-legend.pdf`, over PAM-100 Sanitary)

### 2.1 Group: "260722_Public Amenities Block Hydraulic Sewer Rev T1"
...
| Dark-green filled circle | DWV PIPE REDUCER 100 X 50MM | 1 | EA |
| Blue gear/cog | 100mm ORG | 1 | EA |
| Red/pink triangle | IN WALL TUNDISH | 2 | EA |
| Green flag | 100 Exp/Knuckle Joint | 1 | EA |
| Green 4-dot cluster | 100 4-way riser (2*40)(2*50) | 2 | EA |
| Green ringed circle | 100 mm clear out | 6 | EA |
| Orange crossed circle (⊗) | FWG | 3 | EA |

### 2.2 Group: "260701_Public Amenities Block Hydraulic Vent Rev T1"

| Legend key | Item (verbatim) | Qty | Unit |
|---|---|---|---|
| Dark-red line | DWV PVC PIPE 65MM SN 6 | 1.93 | m |
| Red tick | DWV BEND 65X90 DEG | 1 | EA |
| Teal/green tick | DWV BEND 65 X 45 DEG | 1 | EA |

### 2.3 Group: "260701_Public Amenities Block Hydraulic SW REV T1"
...
## 3. Legend transcription — Plan F (`F H-PAM-~2-legend.pdf`, over PAM-200 Water)

### 3.1 Group: "260722_Public Amenities Block Hydraulic Sewer Rev T1"
...
| Legend key | Item (verbatim) | Qty | Unit |
|---|---|---|---|
| Red dash-dot line | 40mm x PE100 PN16 blue stripe pipe | 3.27 | m |
| Olive dashed line | copper tube type B 32MM | 9.56 | m |
| Orange line | Copper tube type B 25MM | 26.90 | m |
| Olive-green dashed line | Copper tube Type B 20 mm | 0.96 | m |
| Red double-tick | B-PRESS WATER ELBOW 90DEG X 20MM | 2 | EA |
| Yellow/orange circle | B-PRESS WATER REDUCING COUP 25X20MM (EA) | 1 | EA |
| Green/red half-shield | HOSE TAP | 1 | EA |
| Red circled dot (⊙) | 32MM DOEMSTIC WATER METER *(sic)* | 1 | EA |
| Orange double-arrow | B-PRESS WATER EQUAL TEE 32MM (EA) | 1 | EA |
| Magenta double-arrow | B-PRESS WATER Reducing TEE 32MM x25 MM(EA) | 2 | EA |
| Orange tick | B-PRESS WATER ELBOW 90DEG X 32MM (EA) | 1 | EA |
| Orange-red tick | B-PRESS WATER ELBOW 90DEG X 25MM | 15 | EA |
| Orange double-arrow (smaller) | B-PRESS WATER EQUAL TEE 25MM (EA) | 7 | EA |
| Red/white square | 32mm Poly to 32mm Copper B Press Adapter | 1 | EA |
| Light-green dashed line | 20 PEX PIPE_BLACK (meter ) | 18.86 | m |
| Blue diamond | PEX - 32 Cu Crimp Adapter | 2 | EA |
| Purple/magenta diamond | PEX - 25 Cu Crimp Adapter | 1 | EA |
...
## 4. Consolidated take-off (MEASURED quantities, whole PAM set)

### 4.1 Pipe (measured lengths)

| Item | Plan D (PAM-100) | Plan F (PAM-200) | **Set total** | Unit |
|---|---|---|---|---|
| DWV PVC pipe 100mm SN6 (sewer) | 60.71 | 0.45 | **61.16** | m |
| DWV PVC pipe 50mm SN8 | 6.93 | — | **6.93** | m |
| DWV PVC pipe 65mm SN6 (vent) | 1.93 | — | **1.93** | m |
| PE100 PN16 40mm blue-stripe (inground CW) | — | 3.27 | **3.27** | m |
| Copper tube Type B 32mm | — | 9.56 | **9.56** | m |
| Copper tube Type B 25mm | — | 26.90 | **26.90** | m |
| Copper tube Type B 20mm | — | 0.96 | **0.96** | m |
| PEX 20 black (CW) | — | 18.86 | **18.86** | m |
| PEX 20 red (HW/warm) | — | 5.89 | **5.89** | m |

### 4.2 Fittings and equipment (counts)

| Item | Plan D | Plan F | **Set total** | Unit |
|---|---|---|---|---|
| DWV bend 100 × 90° | 20 | 1 | **21** | EA |
| DWV bend 100 × 45° | 21 | — | **21** | EA |
| DWV junction 100 × 45° | 22 | — | **22** | EA |
| DWV bend 50 × 85° | 4 | — | **4** | EA |
| DWV bend 50 × 45° | 2 | — | **2** | EA |
| DWV reducer 100 × 65mm | 1 | — | **1** | EA |
| DWV reducer 100 × 50mm | 1 | — | **1** | EA |
| 100mm ORG | 1 | — | **1** | EA |
| In-wall tundish (IWTD) | 2 | — | **2** | EA |
| 100 exp/knuckle joint | 1 | — | **1** | EA |
| 100 4-way riser (2×40)(2×50) | 2 | — | **2** | EA |
| 100mm clear out (CO) | 6 | — | **6** | EA |
| FWG | 3 | — | **3** | EA |
| DWV bend 65 × 90° (vent) | 1 | — | **1** | EA |
| DWV bend 65 × 45° (vent) | 1 | — | **1** | EA |
| B-press elbow 90° × 20mm | — | 2 | **2** | EA |
| B-press reducing coupling 25 × 20mm | — | 1 | **1** | EA |
| Hose tap (HT/VP vandal-proof per dwg) | — | 1 | **1** | EA |
| 32mm domestic water meter (check-meter assembly) | — | 1 | **1** | EA |
| B-press equal tee 32mm | — | 1 | **1** | EA |
| B-press reducing tee 32 × 25mm | — | 2 | **2** | EA |
| B-press elbow 90° × 32mm | — | 1 | **1** | EA |
| B-press elbow 90° × 25mm | — | 15 | **15** | EA |
| B-press equal tee 25mm | — | 7 | **7** | EA |
| 32mm poly to 32mm copper B-press adapter | — | 1 | **1** | EA |
| PEX–Cu crimp adapter 32 | — | 2 | **2** | EA |
| PEX–Cu crimp adapter 25 | — | 1 | **1** | EA |
| PEX–Cu crimp adapter 20 | — | 1 | **1** | EA |
| PEX 20 elbow | — | 16 | **16** | EA |
